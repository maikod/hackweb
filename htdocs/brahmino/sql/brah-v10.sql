...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 27, 2018 at 05:22 PM
...
(1, 'root', '17166193b35a231d8031c52931e06a70', 'frankie@hackweb.it', '27056', 0, '2018-01-27', '2017-12-02 16:41:52');
...
(168, 'wwwwwwwo', 'www', 'files/file_upload/img/info-header.jpg', NULL, NULL, 1, NULL, '2018-01-21 16:31:20', 0, 0);
...
DROP TABLE IF EXISTS `brah_presets`;
CREATE TABLE IF NOT EXISTS `brah_presets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `brah_purchases`;
CREATE TABLE IF NOT EXISTS `brah_purchases` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
