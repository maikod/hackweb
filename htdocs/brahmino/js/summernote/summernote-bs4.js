...
var VideoDialog = /** @class */ (function () {
    ...
    VideoDialog.prototype.createVideoNode = function (url) {
        ...
        if (ytMatch && ytMatch[1].length === 11) {
            ...
            $video = $$1('</p>').append($$1('<div>').addClass('video-container').append($$1('<iframe>')
            .attr('frameborder', 0)
            .attr('src', '//www.youtube.com/embed/' + youtubeId)
            .attr('width', '100%').attr('height', '100%').css('position', 'absolute').css('top','0').css('left','0')).append(''));        
        }
            ...
            $video = $$1('</p>').append($$1('<div>').addClass('video-container').append($$1('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
            .attr('frameborder', 0)
            .attr('src', '//player.vimeo.com/video/' + vimMatch[3])
            .attr('width', '100%').attr('height', '100%').css('position', 'absolute').css('top','0').css('left','0')));           
        }
        ...
        console.log( 'summernote-bs4.js : ' + $video );
        return $video[0];
    };
