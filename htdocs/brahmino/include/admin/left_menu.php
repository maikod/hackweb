...
<div class="admin-left-menu closed-hor">
    <div class="menu-buttons left-menu">
        <ul>
            <li class="big-sec"><a class="adm-btn adm-link" href=""><i class="fas fa-tachometer-alt"></i>Dashboard</a><br></li>            
            <div class="sub-selected">
                <li class="small-sec"><a class="adm-btn adm-link" href="adm-welcome">Welcome</a></li>                             
            </div>

            <li class="big-sec "><a class="adm-btn adm-link" href=""><i class="fas fa-images"></i>Overview</a><br></li>    
            <div class="sub-selected">
                <li class="small-sec"><a class="adm-btn adm-link" href="adm-overview">All Elements</a></li>
                <li class="small-sec"><a class="adm-btn adm-link" href="adm-overview_new_photo">New picture</a></li>        
            ...
            <li class="big-sec "><a class="adm-btn adm-link" href=""><i class="fa fa-book"></i>Presets</a><br></li>    
            <div class="sub-selected">
                <li class="small-sec"><a class="adm-btn adm-link" href="adm-presets_all">All Presets</a></li>
                <li class="small-sec"><a class="adm-btn adm-link" href="adm-presets_new">New Preset</a></li>    
            </div> 
            
            <li class="big-sec "><a class="adm-btn adm-link" href=""><i class="fa fa-rss-square"></i>Press Page</a><br></li>    
            <div class="sub-selected">
                <li class="small-sec"><a class="adm-btn adm-link" href="adm-pressEdit">Edit Page</a></li>
            </div>

            <li class="big-sec "><a class="adm-btn adm-link" href=""><i class="fa fa-info-circle"></i>Info Page</a><br></li>    
            <div class="sub-selected">
                <li class="small-sec"><a class="adm-btn adm-link" href="adm-infoEdit">Edit Page</a></li>
            </div>
