...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300,400|Quattrocento" rel="stylesheet">
...
<body onresize="" style="" onload="">
    ...
    <div id="main_page">        
                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav navbar-center">
                            ...
                            <!-- <li><a class="nav-link" href="#hw-presets">presets</a></li>                                                     -->
                            <li><div class="nav-separator">//</div></li>
                            <li><a class="" target="_blank" href="libs/createPDF.php">moodboard (<span class="index-moodb"></span>)</a></li>                                                                                    
                        </ul>
        ...
        <div class="pre-footer" style="text-align:center">            
            <hr class="hr2">
            <button type="submit" class="btn btn-default" style="margin-top:10px;"><a target="_blank" title="Instagram" href="http://instagram.com/brahmino" style="color:#222222;"><i class="fab fa-instagram"></i> BRAHMINO</a></button>        
            <br><br>
        ...
        <div class="blog-footer" style="text-align: center;">    
            ...
            <div class="social-links">
			    <a target="_blank" title="Instagram" href="http://instagram.com/brahmino"><i class="fab fa-instagram"></i></a>
                <a target="_blank" title="Youtube" href="https://www.youtube.com/channel/UCjZqhF7UUC5yhMWe0e3WQsQ"><i class="fab fa-youtube"></i></a>
                <a target="_blank" href="http://twitter.com/Brahmino"><i class="fab fa-twitter"></i></a>
                <a target="_blank" href="https://www.facebook.com/Brahmino/"><i class="fab fa-facebook-square"></i></a>
            </div>                        
        </div>
        <!-- /.footer -->
    </div>
    ...
    <!-- cookie -->
    <div id="accept_cookie" style="<?php echo @$_COOKIE['cookiePolicy']; ?>">
