...
var VideoDialog = /** @class */ (function () {
    ...
    VideoDialog.prototype.createVideoNode = function (url) {
        ...
        if (ytMatch && ytMatch[1].length === 11) {
            ...
            $video = $$1('<div>').addClass('video-container').append($$1('<iframe>')
                .attr('frameborder', 0)
            ...
            $video = $$1('<div>').addClass('video-container').append($$1('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
                .attr('frameborder', 0)
